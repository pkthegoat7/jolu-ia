          ...
          <div className="fu1 glass rounded-3xl p-8"
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <button type="submit" disabled={busy}
                ...
                {busy
                  ? <span className="flex items-center justify-center gap-2.5"><span className="h-4 w-4 rounded-full border-2 border-white/25 border-t-white animate-spin" />Entrando...</span>
                  : 'Entrar no Painel'}
              </button>
            </form>
          </div>
